...
public class UnshardedBasicTest {
    ...
    public void testBasicDiscovery() throws Exception {
        HttpResponseDecoder<UnshardedClusterInfo> deserializer = new HttpResponseDecoder<UnshardedClusterInfo>() {
            @Override
        ...
        HttpSourceConfig<UnshardedClusterInfo> httpSourceConfig = new HttpSourceConfig<UnshardedClusterInfo>("localhost", 8080, "/test", deserializer, false, false, new GetHttpVerb());
