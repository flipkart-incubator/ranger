...
public class UnshardedClusterFinder extends ServiceFinder<UnshardedClusterInfo, ListBasedServiceRegistry, UnshardedCriteria> {
    public UnshardedClusterFinder(ListBasedServiceRegistry serviceRegistry,
